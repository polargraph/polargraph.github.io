export function saveAsSVG( dataPoints, camera, rendererWidth, rendererHeight, fileName ) {
        ...
        let header = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + rendererWidth
                     + rendererHeight + '" width="' + rendererWidth + '" height="' + rendererHeight + '" style="background-color: rgb(255, 255, 255);"><path d="';
